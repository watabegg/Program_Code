...
% Define nodes
\node[root] (A1) {\begin{tabular}{lc}1 & Arad \\ \hline & 0 \\ & 366 \\ & null \end{tabular}};
\node[node, right=of A1] (B2) {Sibiu\\140\\393\\1};
\node[leaf, above right=0.5cm and 1cm of A1] (A3) {Timișoara\\118\\447\\1};
\node[leaf, below right=0.5cm and 1cm of A1] (A4) {Zerind\\75\\449\\1};

\node[leaf, above right=0.5cm and 1cm of B2] (B5) {Arad\\280\\546\\2};
\node[leaf, right=of B2] (B6) {Făgăraș\\239\\415\\2};
\node[leaf, below=0.5cm of B6] (B7) {Oradea\\291\\671\\2};
\node[node, below=0.5cm of B7] (B8) {R.V.\\220\\413\\2};

\node[leaf, right=of B6] (B12) {Bucharest\\450\\450\\6};
\node[leaf, below=0.5cm of B12] (B13) {Sibiu\\338\\591\\6};

\node[leaf, right=of B8] (B9) {Craiova\\366\\526\\8};
\node[node, below=0.5cm of B9] (B10) {Pitești\\317\\417\\8};

\node[node, right=of B10] (B14) {Bucharest\\418\\418\\10};
\node[leaf, below=0.5cm of B14] (B15) {Craiova\\455\\615\\10};
\node[leaf, below=0.5cm of B15] (B16) {R.V.\\414\\607\\10};

\node[leaf, below=0.5cm of B10] (B11) {Sibiu\\300\\553\\8};
