...
#元のデータファイル名
fname_datas = ["example2.txt", "nh_covid-italy.txt", "nh_bb_age_weigth.txt", "nh_bb_age_length.txt", "nh_fish.txt", "nh_wine.txt"]
...
for fname_data in fname_datas:
    ...
    #調べるモデル
    for model_number in range(1,27):

        fd = "../data/"+fname_data #データ
        fe = "../results/m"+str(model_number)+"_est_"+fname_data #補完の結果
        ...
        plt.savefig("./"+ fname_data +"/plot_" + str(model_number) + "_" + fname_data + ".png")
        plt.show()
