...
#元のデータファイル名
fname_data = "example2.txt"
#fname_data = "nh_covid-italy.txt";
#fname_data = "nh_bb_age_weigth.txt";
#fname_data = "nh_bb_age_length.txt";
#fname_data = "nh_fish.txt";
#fname_data = "nh_wine.txt";
